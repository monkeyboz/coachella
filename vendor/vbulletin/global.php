...
define('CWD', (($getcwd = getcwd()) ? $getcwd.'/vbulletin' : '.'));
// #############################################################################
...
if ($vbulletin->options['enablepms'] AND ($vbulletin->userinfo['pmunread'] OR ($vbulletin->userinfo['receivepm'] AND $vbulletin->userinfo['permissions']['pmquota'])))
{
