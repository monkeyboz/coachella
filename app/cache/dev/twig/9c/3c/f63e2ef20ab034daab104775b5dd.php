...
class __TwigTemplate_9c3cf63e2ef20ab034daab104775b5dd extends Twig_Template
{
    ...
    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_profiler_search"), "html");
        echo "\" method=\"get\">
        <label for=\"ip\">IP</label>
        <input type=\"text\" name=\"ip\" id=\"ip\" value=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->getContext($context, 'ip'), "html");
        echo "\" />
        ...
        foreach ($context['_seq'] as $context['_key'] => $context['l']) {
            ...
            echo ">";
            echo twig_escape_filter($this->env, $this->getContext($context, 'l'), "html");
            echo "</option>
            ";
        }
