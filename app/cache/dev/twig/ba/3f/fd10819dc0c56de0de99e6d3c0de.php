...
class __TwigTemplate_ba3ffd10819dc0c56de0de99e6d3c0de extends Twig_Template
{
    protected $parent;
    ...
    ";
        ...
        // line 8
        echo "        ";
        if ($this->getAttribute($this->getContext($context, 'collector'), "user", array(), "any", false)) {
            // line 9
            echo "            ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector'), "user", array(), "any", false), "html");
            echo " ";
            if ((!$this->getAttribute($this->getContext($context, 'collector'), "authenticated", array(), "any", false))) {
                echo "<em>(not auth.)</em>";
            }
            // line 10
            echo "        ";
        } elseif ($this->getAttribute($this->getContext($context, 'collector'), "enabled", array(), "any", false)) {
            // line 11
    ...
    <span class=\"icon\"><img src=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/webprofiler/images/profiler/security.png"), "html");
        echo "\" alt=\"\" /></span>
    ...
    ";
        ...
        if ($this->getAttribute($this->getContext($context, 'collector'), "user", array(), "any", false)) {
            ...
            if ($this->getAttribute($this->getContext($context, 'collector'), "authenticated", array(), "any", false)) {
                ...
                // line 40
                echo "                        no ";
                if ((!twig_length_filter($this->env, $this->getAttribute($this->getContext($context, 'collector'), "roles", array(), "any", false)))) {
            ...
            <tr>
                ...
                <td>";
            // line 46
            echo twig_escape_filter($this->env, $this->env->getExtension('yaml')->encode($this->getAttribute($this->getContext($context, 'collector'), "roles", array(), "any", false)), "html");
            echo "</td>
            </tr>
        </table>
    ";
